...
>(function SelectControl(props, ref) {
  ...
  const isDefaultValue = Array.isArray(defaultValue)
    ? context.value.every((item) => defaultValue.includes(item))
...
>(function SelectClearTrigger(props, ref) {
  return (
    <ChakraSelect.ClearTrigger asChild {...props} ref={ref}>
      <CloseButton pointerEvents="auto" />
  ...
  return (
    <ChakraSelect.Root
      ...
      positioning={{
        sameWidth: false,
        ...props.positioning,
        offset: { mainAxis: 4, ...props.positioning?.offset },
      }}
    >
      {props.asChild ? (
        props.children
...
export const Select = React.forwardRef<HTMLDivElement, SelectProps>(
  (props, ref) => {
    ...
    return (
      <SelectRoot ref={ref} collection={collection} {...rest}>
...
export interface SelectAsyncProps extends Omit<SelectProps, "collection"> {
  ...
  ) => Promise<ListCollection<SelectOption>>;
  extraControls?: React.ReactNode;
  mode?: ViewMode;
}

export const SelectAsync = React.forwardRef<HTMLDivElement, SelectAsyncProps>(
  (props, ref) => {
    const {
      placeholder,
      portalled = true,
