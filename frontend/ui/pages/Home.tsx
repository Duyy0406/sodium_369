...
import GpuSupplyDashboard from 'ui/gpuSupplyDashboard/GpuSupplyDashboard'; // Your GPU Supply Dashboard component
...
const Home = () => {
  ...
  return (
    <Box as="main">
      ...
      {/* This is a suitable place to add your custom dashboard.
        It will appear below the main Stats and Chain Indicators,
        and above the Latest Blocks/Transactions section.
      */}
      <GpuSupplyDashboard /> {/* <--- ADD YOUR GPU SUPPLY DASHBOARD HERE */}
